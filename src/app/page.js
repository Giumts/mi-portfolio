...
export default function Home() {
  ...
  const projects = [
    ...
    { id: 7,  title: "san sadurnì",          img: "/fotos_portadas/Portada_San sadurni.jpg",          galleries: [g7p,  g7t,  g7d ], sections: ["project","technical","development"], tech: ["premiere", "lightroom", "after effects"],    desc: "capturando la esencia del movimiento estático. la tensión entre lo quieto y lo dinámico se cristaliza en patrones que dialogan entre la cinemática y la imagen fija.", info: { date: "2023", location: "barcelona", role: "ephemeral architecture" } },
