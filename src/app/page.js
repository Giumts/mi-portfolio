...
export default function Home() {
  ...
  // Mantenemos el movimiento suave (muelle) porque es muy orgánico
  ...
  const projects = [
    { id: 1, title: "Beautiful Failures I", img: "/Portada_24seconds.jpg", desc: "Una búsqueda de la armonía en el error digital y la composición orgánica.", gallery: trailImages },
    { id: 2, title: "Beautiful Failures II", img: "/Portada_Aria libera.jpg", desc: "La imperfección como lenguaje visual predominante.", gallery: trailImages },
    { id: 3, title: "Editorial Study", img: "/Portada_Beautiful failures.jpg", desc: "Exploración rítmica del espacio en blanco.", gallery: trailImages },
    { id: 4, title: "Light & Shadow", img: "/Portada_Ledsc4.jpg", desc: "El contraste extremo define la forma.", gallery: trailImages },
    { id: 5, title: "Visual Concept", img: "/Portada_Now you see me moria.jpg", desc: "Abstracción aplicada al diseño contemporáneo.", gallery: trailImages },
    { id: 6, title: "Archive 01", img: "/Portada_rise up.jpg", desc: "Fragmentos de un proceso inacabado.", gallery: trailImages },
    { id: 7, title: "Motion Texture", img: "/Portada_San sadurni.jpg", desc: "Capturando la esencia del movimiento estático.", gallery: trailImages },
    { id: 8, title: "Silence", img: "/Portada_vora.jpg", desc: "Reducción visual al mínimo exponente.", gallery: trailImages },
  ...
  return (
    <main style={{ backgroundColor: "white", minHeight: "100vh", width: "100vw", position: "relative", cursor: "crosshair" }}>
      ...
      {/* TEXTO FLOTANTE LIMPIO (SIN CUADROS NI BORDES) */}
      <AnimatePresence>
        {isHovering && view === "detail" && (
          ...
          >
            <p style={{ fontSize: "1.4rem", fontWeight: "bold", lineHeight: "1.1" }}>
              {selectedProject?.title}
            </p>
            <p style={{ fontSize: "0.7rem", marginTop: "5px", lineHeight: "1.4" }}>
              lorem ipsum dolor sit amet, consectetur adipiscing elit. view details.
            </p>
          </motion.div>
        )}
      </AnimatePresence>
