...
  const [detailInfoPositions, setDetailInfoPositions] = useState({}); // Estado para posiciones aleatorias de info
...
    { url: "/fotos_detalle/24_3.mp4", text: "frame 03" }, { url: "/fotos_detalle/24_4.jpg", text: "frame 04" }, // Este es un video
...
    { url: "/fotos_detalle/bf_5.png", text: "After studying the imperfections that time left on the ground, we transformed them through a digital scan, into 3D objects, and then placed the pieces of glass on the surface, connecting them for aesthetic appearance." }, { url: "/fotos_detalle/bf_6.png", text: "fail 06" },
    { url: "/fotos_detalle/bf_7.png", text: "fail 07" }, { url: "/fotos_detalle/bf_8.jpg", text: "fail 08" },
  ];
  const gallery4 = [
...
    }
    if (view === "detail") {
      // Generar posiciones aleatorias para info arriba derecha al entrar
...
              <motion.div 
                key={proj.id} 
                drag // <--- AHORA DRAGGABLE
                dragConstraints={containerRef} // LÍMITES DE PANTALLA
...
            <Crosshair color={kleinBlue} />
            ...
            {/* INFO FIJA ARRIBA DERECHA - POSICIONES ALEATORIAS */}
