...
import ImageTrail from "./ImageTrail"; // Asegúrate de que este archivo existe en la misma carpeta
...
export default function Home() {
  ...
  const projects = [
    { 
      ...
      gallery: [{ src: "/BEAUTIFUL_FAILURES_AY1.jpg", text: "instante suspendido" }, { src: "/BEAUTIFUL_FAILURES_AY3.jpg", text: "ruido visual" }]
    },
    { 
      ...
      gallery: [{ src: "/BEAUTIFUL_FAILURES_AY37.jpg", text: "aire contenido" }, { src: "/BEAUTIFUL_FAILURES_AY42.jpg", text: "abstracción" }]
    },
    { 
      ...
      gallery: [{ src: "/BEAUTIFUL_FAILURES_AY49.jpg", text: "caos ordenado" }]
    },
  ...
  return (
    <main style={{ backgroundColor: "white", minHeight: "100vh", width: "100vw", position: "relative", overflowX: "hidden" }}>
      ...
      <nav style={{ zIndex: 1001 }}>
        {view === "home" ? (
          <>
            <motion.h1 onClick={() => setView("home")} style={{ position: "fixed", top: "5vh", width: "100%", textAlign: "center", textDecoration: "line-through", fontFamily: fontTitle, color: kleinBlue, fontSize: "1.1rem", cursor: "pointer" }}>giulia</motion.h1>
          ...
          <>
            ...
            <div onClick={() => {setView("projects"); setSelectedProject(null)}} style={{ position: "fixed", bottom: "4vh", left: "4vw", fontFamily: fontBody, fontSize: "0.8rem", color: "#000", cursor: "pointer", textDecoration: view === "projects" ? "line-through" : "none" }}>projects</div>
            <div onClick={() => {setView("about"); setSelectedProject(null)}} style={{ position: "fixed", bottom: "4vh", right: "4vw", fontFamily: fontBody, fontSize: "0.8rem", color: "#000", cursor: "pointer", textDecoration: view === "about" ? "line-through" : "none" }}>about</div>
          </>
        )}
      </nav>
