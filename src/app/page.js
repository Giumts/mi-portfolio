...
export default function Home() {
  ...
  const projects = [
    ...
    { id: 9,  title: "space creation set",   img: "/fotos_portadas/Portada_Shoot LAMP.png",           galleries: [[],   [],   []  ], sections: ["project","technical","development"], tech: ["cinema 4d", "blender", "lightroom"],         desc: "objetos que definen el espacio que los rodea. una exploración sobre cómo la luz y la forma construyen atmósferas, donde cada pieza existe en diálogo con su entorno.", info: { date: "2024", location: "remote", role: "ui design" } },
    ...
    { id: 11, title: "eureka",                 img: "/fotos_detalle/eu_1.png",                          galleries: [[],   [],   []  ], sections: ["project","technical","development"], tech: [],                                            desc: "", info: { date: "2024", location: "remote", role: "product design" } },
    { id: 12, title: "prometeo",               img: "/fotos_detalle/pr_1.JPG",                          galleries: [[],   [],   []  ], sections: ["project","technical","development"], tech: [],                                            desc: "", info: { date: "2024", location: "remote", role: "product design" } }
  ];
